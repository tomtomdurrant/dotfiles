...
_G.packer_plugins = {
  ...
  ["bufdelete.nvim"] = {
    loaded = true,
    path = "/Users/tom/.local/share/nvim/site/pack/packer/start/bufdelete.nvim",
  ...
  ["editorconfig.nvim"] = {
    ...
    loaded = true,
    path = "/Users/tom/.local/share/nvim/site/pack/packer/start/editorconfig.nvim",
    url = "https://github.com/gpanders/editorconfig.nvim"
  },
  ["everblush.vim"] = {
    loaded = true,
    path = "/Users/tom/.local/share/nvim/site/pack/packer/start/everblush.vim",
  ...
  ["kanagawa.nvim"] = {
    loaded = true,
    path = "/Users/tom/.local/share/nvim/site/pack/packer/start/kanagawa.nvim",
  ...
  melange = {
    loaded = true,
    path = "/Users/tom/.local/share/nvim/site/pack/packer/start/melange",
  ...
  ["nvcode-color-schemes.vim"] = {
    loaded = true,
    path = "/Users/tom/.local/share/nvim/site/pack/packer/start/nvcode-color-schemes.vim",
  ...
  ["nvim-code-action-menu"] = {
    ...
    needs_bufread = true,
    only_cond = false,
    path = "/Users/tom/.local/share/nvim/site/pack/packer/opt/nvim-code-action-menu",
  ...
  ["nvim-lsp-ts-utils"] = {
    loaded = true,
    path = "/Users/tom/.local/share/nvim/site/pack/packer/start/nvim-lsp-ts-utils",
  ...
  ["nvim-lsputils"] = {
    loaded = true,
    path = "/Users/tom/.local/share/nvim/site/pack/packer/start/nvim-lsputils",
  ...
  popfix = {
    loaded = true,
    path = "/Users/tom/.local/share/nvim/site/pack/packer/start/popfix",
  ...
  ["stylua-nvim"] = {
    loaded = true,
    path = "/Users/tom/.local/share/nvim/site/pack/packer/start/stylua-nvim",
    url = "https://github.com/ckipp01/stylua-nvim"
  },
  ["tabout.nvim"] = {
    loaded = true,
    path = "/Users/tom/.local/share/nvim/site/pack/packer/start/tabout.nvim",
  ...
  ["telescope-termfinder.nvim"] = {
    loaded = true,
    path = "/Users/tom/.local/share/nvim/site/pack/packer/start/telescope-termfinder.nvim",
  ...
  ["trld.nvim"] = {
    ...
    loaded = true,
    path = "/Users/tom/.local/share/nvim/site/pack/packer/start/trld.nvim",
  ...
  ["vim-moonfly-colors"] = {
    loaded = true,
    path = "/Users/tom/.local/share/nvim/site/pack/packer/start/vim-moonfly-colors",
  ...
  ["vim-ultest"] = {
    loaded = true,
    path = "/Users/tom/.local/share/nvim/site/pack/packer/start/vim-ultest",
